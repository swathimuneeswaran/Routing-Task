...
const Fullstack = () => {
  ...
  return (
    ...
    <div className="container">
      <div className="box">
        <h1 style={{color:"gray"}}>Full Stack Development</h1>
        <div className="ibox">
        <p>Are you a curious geek with an unstoppable urge to develop? Then, your Full Stack Development knack would be<br></br> sun-glazed with an innovative and informative piece of knowledge that comes from Top industrialists and<br></br> Appreneurs!</p>

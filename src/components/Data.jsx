...
const Data = () => {
  ...
  return (
    <>
      ...
      <div className="box">
        <h1 style={{color:"gray"}}>Data Science📄</h1>
        <div className="ibox">
        <p>One of the most propelling careers on the planet today, Data Science is a vast arena of diverse technologies<br></br> and techniques. Are you ready to step into the world of Data? Then you probably should not miss this <br></br>corner of articles that is an assorted curation out of tedious research & exploration.</p>
        <p>The GUVI Blog’s Full Stack Development category is here to help you steer through a lot of opinions that float on<br></br> the internet. High-Quality content curated by experts!📈</p>
      </div>
      </div>
        <div className="row">
          {cards.map((card) => (
